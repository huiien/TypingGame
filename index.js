...
// Count down timer for 20 seconds
 	function countdown() {
 		...
 		var timer = setInterval(function(){
    		...
    		if (seconds === 0) {
    			alert("Game over! Your score is " + points); //when times up
...
//random generator to choose word from list
  	function random() {
  		words.innerHTML = "";
...
// look for typed character
  	function typing(e) {
  			...
  			for (var j = 0; j < spans.length; j++) { //checking if all the letters are typed
  				...
  				if (checker === spans.length) { // if so, play correct music
            correct.play();
